...
<script src="${path}/js/zh.js"></script>
    <h1>添加商品</h1>
    <div class="form">
        <form action="${path}/user/addProduct" method="post" enctype="multipart/form-data" role="form">
            <div class="form-group">
                <label for="name" class="item">商品名称:</label>
                <input type="text" class="form-control" name="name" id="name" placeholder="添加商品名称" required maxlength="15">
            </div>
            <div class="form-group">
                <label for="description" class="item">文字描述:</label>
                <textarea class="form-control text" rows="5" name="description" id="description" placeholder="添加文字描述" required></textarea>
            </div>
            <div class="form-group">
                <label for="price" class="item">参考价格(元):</label>
                <input type="number" class="form-control" name="price" id="price" placeholder="标出您的价格,请填写整数" required/>
            </div>
